    ...
    <div class="other-bg">
        <div class="container mb-5">
            <div class="col-md-10 pt-4">
                ...
                <div class="row mb-5 pl-3" v-for="form in all_forms" :key="form.id">
                    <div v-if="form.process_title !== null">
                        ...
                        <a :href="form.video_file" :download="form.process_title + ' - video'" v-if="form.video_file !== null">
                            <button type="submit" class="btn btn-primary mr-4"> Video Tutorial </button>
                        </a>
                        <a :href="form.audio_file" :download="form.process_title + ' - audio'" v-if="form.audio_file !== null">
                            <button type="button" class="btn btn-primary mr-4"> Audio Tutorial </button>
                        </a>
                        <a :href="form.instruction_file" :download="form.process_title + ' - instruction'" v-if="form.instruction_file !== null">
                            <button type="button" class="btn btn-primary mr-4"> Download {{ form.process_title }} </button>
                        </a>
                    </div>
                </div>
            </div>
